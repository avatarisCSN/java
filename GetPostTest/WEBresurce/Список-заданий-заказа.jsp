<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    <%@ page import="java.util.*, java.text.*, java.sql.Connection, java.sql.ResultSet, java.util.ArrayList, java.sql.SQLException, java.sql.Statement, src.Connector" %>
...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Список заданий заказа</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Список-заданий-заказа.css" media="screen">
    ...
    <meta property="og:title" content="Список заданий заказа">
          ...
          <table class="u-table-entity u-table-entity-1">
            ...
            <thead class="u-palette-4-base u-table-header u-table-header-1">
              <tr style="height: 21px;">
                ...
                <th class="u-border-1 u-border-palette-4-base u-table-cell"> Унікальний код  </th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell"> Ідентіфікатор проекту </th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell"> Номер замовлення </th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Позначення виробу  </th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Позначення головного виробу </th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Повне ім'я</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Тип завдання</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Виробнича програма</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">ASUDET Kod</th>
              </tr>
            </thead>
...
if (request.getParameter("radio1")!=null)
{
	Connection connection;
	  try {
	             ...
	             String sql_query =  "SELECT * FROM голубов_диплом.zamovlitem WHERE zamovlitem.ObozZamov='"+Integer.parseInt(request.getParameter("radio1"))+"'";
	             ResultSet rs = statement.executeQuery(sql_query);
	             while (rs.next()) {
	            	 %>
	               <tr style="height: 30px;">
	                <td class="u-border-1 u-border-grey-30 u-first-column u-grey-5 u-table-cell u-table-cell-13"><input type="radio" form="myform1" name="radio1" value=<%=rs.getInt(1)%>></td>
	                ...
	                <td class="u-border-1 u-border-grey-30 u-table-cell"><%=rs.getInt(3)%></td>
	                ...
	                <td class="u-border-1 u-border-grey-30 u-table-cell"><%=rs.getInt(8)%></td>
	                <td class="u-border-1 u-border-grey-30 u-table-cell"><%=rs.getString(14)%></td>
	              </tr>
...
Connection connection;
  try {
            	 connection = Connector.Connect();
             Statement statement = connection.createStatement();
             String sql_query =  "SELECT * FROM голубов_диплом.zamovlitem";
             ResultSet rs = statement.executeQuery(sql_query);
             while (rs.next()) {
            	 %>
               <tr style="height: 30px;">
          ...
          <div class="u-repeater u-repeater-1">
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-1">
                <input form="myform1" formaction="${pageContext.request.contextPath}/Редактирование-единицы-заказа.jsp" class="u-btn u-btn-round u-button-style u-custom-item u-hover-palette-1-light-1 u-palette-1-base u-radius-6 u-btn-1" name="btn1" type="submit" value="Редагувати">
            ...
            <div class="u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-3">
                 ...
                 <input form="myform1" formaction="${pageContext.request.contextPath}/опис-детали.jsp" name="btn1" class="u-btn u-btn-round u-button-style u-custom-item u-hover-palette-1-light-1 u-palette-1-base u-radius-6 u-btn-1" type="submit" value="Опис Деталі">
                  </form>
              </div>
            </div>
          </div>
