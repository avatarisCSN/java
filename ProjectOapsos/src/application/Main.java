...
public class Main extends Application {
	...
	{
		Label label7 = new Label("введите дату и запустите программу");
		
		 Label label1 = new Label("число1");
	        Label label2 = new Label("число2");
	        Label label3 = new Label("число3");
	        Label label4 = new Label("число4");
	        Label label5 = new Label("число5");
	        Label label6 = new Label("число6");
	        ...
	        TextField text1 = new TextField("дата1");
        ...
        grid2.setGridLinesVisible(true); // делаем видимой сетку строк и столбцов
	    
	    
	    
	    Button btn11= new Button("Расчет матрицы");
		Button btn12= new Button("Расчет потенциала");
		Button btn13= new Button("Справка по квадратам");
		    ...
		    ScrollPane scroll = new ScrollPane(Scenes.txt);
		        ...
		        HBox menu2 = new HBox(Scenes.btn21, Scenes.btn22, Scenes.btn23);
			     ...
			     Label lbl5_1 = new Label("Введите месяц и год");
			        TextField text5_1 = new TextField("месяц");
			        ...
			        Button btn5_1_1 = new Button("start");
				     ...
				     GridPane grid3 = new GridPane();
				        ...
				        grid3.setGridLinesVisible(true); // делаем видимой сетку строк и столбцов
